...
if(isset($_POST['addhos'])){
  ...
  {
    $upload_dir = 'hospic/'; //upload diredctory image
...
$mail = $_POST['mail'];
$hours = $_POST['hours'];
$qry = $cn -> query("INSERT INTO hospital (id,name,location,contact,service,gmail,acname,acimg,hours5) values (null,'$nm','$loc','$con','$serv','$mail','$imgFile','$pic',$hours)") or die (mysqli_error());
